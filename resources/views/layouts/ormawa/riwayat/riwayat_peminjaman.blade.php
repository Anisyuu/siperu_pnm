<x-master>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        {{-- FILTER --}}
        <form method="GET" action="{{ route('ormawa.riwayat-peminjaman') }}" class="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
            <div class="flex flex-col md:flex-row gap-3">
                ...
                <a href="{{ route('ormawa.riwayat-peminjaman') }}"

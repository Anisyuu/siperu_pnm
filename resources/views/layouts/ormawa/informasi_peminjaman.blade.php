    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <div>
            ...
            <p class="mt-0.5 text-sm text-slate-500">
                Panduan alur peminjaman ruangan untuk ormawa
            </p>
        </div>
            ...
            <div class="space-y-4">
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-0.5">Ormawa memilih ruangan untuk kegiatan organisasi.</p>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-0.5">Ormawa mengisi nama kegiatan, jadwal, kebutuhan ruangan, dan dokumen pendukung kegiatan.</p>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-0.5">Pengajuan ormawa akan melalui alur verifikasi sesuai ketentuan sistem.</p>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-0.5">Ormawa dapat mengecek status pengajuan melalui menu Peminjaman atau Riwayat.</p>
                    </div>
                </div>
            </div>
        </div>

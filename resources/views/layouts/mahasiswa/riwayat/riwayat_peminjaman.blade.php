    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <form method="GET" action="{{ route('mahasiswa.riwayat-peminjaman') }}" class="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
            <div class="flex flex-col md:flex-row gap-3">
                ...
                @endif
                <a href="{{ route('mahasiswa.riwayat-peminjaman.export', request()->query()) }}"
                            ...
                            <tr class="hover:bg-slate-50/70 transition-colors group">
                                ...
                                <td class="px-5 py-4 text-center">
                                    <div class="flex justify-center items-center gap-2">
                                        <a href="{{ route('mahasiswa.detail-peminjaman', $item->id) }}"
                                        ...
                                        @if ($item->status == 'pending')
                                            <form action="{{ route('mahasiswa.batalkan-peminjaman', $item->id) }}" method="POST" class="inline"

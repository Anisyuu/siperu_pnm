<x-master>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        {{-- FILTER --}}
        <form method="GET" action="{{ route('karyawan.riwayat-peminjaman') }}" class="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
                            ...
                            <tr class="hover:bg-slate-50/70 transition-colors group">
                                ...
                                <td class="px-5 py-4 text-center">
                                    <div class="flex justify-center items-center gap-2">
                                        <a href="{{ route('karyawan.detail-peminjaman', $item->id) }}"
                                        ...
                                        @if ($item->status == 'pending')
                                            <form action="{{ route('karyawan.batalkan-peminjaman', $item->id) }}" method="POST" class="inline"

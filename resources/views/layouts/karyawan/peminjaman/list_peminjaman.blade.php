    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('karyawan.ajukan-peminjaman') }}"
        ...
        {{-- FILTER --}}
        <form method="GET" action="{{ route('karyawan.list-peminjaman') }}" class="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
            <div class="flex flex-col md:flex-row gap-3">
                ...
                <a href="{{ route('karyawan.list-peminjaman') }}"
                                    ...
                                    <div class="flex justify-center items-center gap-2">
                                        ...
                                        @if ($item->status == 'pending' && $item->verifikasi->count() == 0)
                                            ...
                                            <form id="delete-peminjaman-{{ $item->id }}"
                                                action="{{ route('karyawan.batalkan-peminjaman', $item->id) }}"
                                                method="POST"
                                                class="hidden">
                                                @csrf
                                                @method('DELETE')

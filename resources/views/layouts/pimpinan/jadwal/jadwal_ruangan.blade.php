...
<div class="bg-slate-100 min-h-screen px-8 py-10">
    <div class="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h2 class="text-slate-900 text-3xl font-extrabold tracking-tight">Jadwal Ruangan</h2>
                <p class="text-slate-500 text-sm mt-1">Lihat dan filter jadwal penggunaan ruangan</p>
            </div>
            <div class="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 rounded-2xl text-sm font-semibold text-slate-700 shadow-sm">
        ...
        {{-- FILTER --}}
        <form method="GET" action="{{ url()->current() }}" class="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
            <div class="flex flex-col md:flex-row gap-3 md:items-end">

                <div class="flex flex-col flex-1">
                    <label class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Ruangan</label>
                ...
                <div class="flex flex-col flex-1">
                    <label class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Tanggal</label>
                    <input type="date"
                           name="tanggal"
                ...
                <div class="flex flex-col flex-1">
                    <label class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Cari</label>
                    <div class="relative">
                ...
                <div class="flex shrink-0 gap-2">
                    ...
                    <a href="{{ url()->current() }}"
                       class="px-4 py-2.5 inline-flex items-center justify-center border border-slate-200 text-sm font-semibold rounded-xl bg-white hover:bg-slate-50 transition text-slate-500">
                        Reset
                    </a>
                </div>
            </div>
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex justify-end">
                <div class="flex items-center bg-white rounded-xl border border-slate-200 px-3 py-1.5 shadow-sm">
                    ...
                    <span class="px-4 text-sm font-bold text-slate-800">{{ $monthLabel }}</span>

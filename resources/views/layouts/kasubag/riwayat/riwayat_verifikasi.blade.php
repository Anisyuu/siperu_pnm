...
<div class="max-w-7xl mx-auto flex flex-col gap-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-0.5 text-sm text-slate-500">Riwayat seluruh pengajuan yang telah Anda verifikasi</p>
        </div>
        <a href="{{ route('kasubag.riwayat-verifikasi.export', request()->query()) }}"

...
<div class="max-w-7xl mx-auto flex flex-col gap-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h2 class="text-slate-900 text-3xl font-extrabold tracking-tight">Riwayat Peminjaman</h2>
            <p class="text-slate-500 text-sm mt-1">Riwayat seluruh pengajuan peminjaman ruangan</p>
        </div>

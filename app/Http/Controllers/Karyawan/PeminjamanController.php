...
class PeminjamanController extends Controller
{
    ...
    public function listPeminjaman(Request $request)
    {
        ...
        return view('layouts.karyawan.peminjaman.list_peminjaman', compact('peminjaman'));
    }
    ...
    public function ajukanPeminjaman()
    {
        ...
        return view('layouts.karyawan.peminjaman.ajukan_peminjaman',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('karyawan.list-peminjaman')
                ->with('success', 'Pengajuan berhasil dikirim.');

        } catch (\Exception $e) {
            Log::error('[store peminjaman karyawan] error', [
    ...
    public function detailPeminjaman($id)
    {
        ...
        return view('layouts.karyawan.peminjaman.detail_peminjaman', compact(
            'peminjaman',
            'alur',
            'riwayat'
        ));
    ...
    public function riwayatPeminjaman(Request $request)
    {
        ...
        return view('layouts.karyawan.riwayat.riwayat_peminjaman', compact('peminjaman'));
    }
    ...
    public function exportRiwayatPeminjaman(Request $request)
    {
        ...
        $fileName = 'riwayat-peminjaman-karyawan-' . now()->format('Ymd_His') . '.csv';

...
class DashboardController extends Controller
{
    public function dashboard(Request $request)
    {
        ...
        /*
        |--------------------------------------------------------------------------
        | STAT CARD SARPRAS SEBAGAI VERIFIKATOR
        |--------------------------------------------------------------------------
        | Menghitung peminjaman berdasarkan gedung yang menjadi tanggung jawab
        | Sarpras yang sedang login.
        |--------------------------------------------------------------------------
        */
        ...
        $menunggu = Peminjaman::query()
            ...
            ->whereHas('ruangan.gedung', function ($q) use ($userId) {
        ...
        */
        ...
        return view('layouts.sarpras.dashboard', [
            'events'       => $events,
